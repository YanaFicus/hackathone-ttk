            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-linear-to-r from-blue-50 to-purple-50 border-b border-gray-200">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-gray-700">Прямой эфир</span>
                </div>
              ...
              {/* Центральная часть: Аудио визуализация */}
              <div className="bg-slate-900 aspect-video flex flex-col items-center justify-center relative">
                ...
                <div className="relative mb-6">
                  ...
                  <div className="absolute inset-2 bg-primary rounded-full animate-pulse opacity-40"></div>
                  <button 
                    onClick={handlePlayPause}
                    className="relative w-24 h-24 bg-linear-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center hover:scale-105 transition-transform shadow-2xl"
                  >
                    {isPlaying ? (
                ...
                <h2 className="text-xl font-semibold text-white mb-2">Аудиопоток</h2>
              ...
              <div className="p-4 bg-gray-50 border-t border-gray-200">
                <div className="flex items-center gap-4">
                  ...
                  <button 
                    onClick={handlePlayPause}
                    className="w-12 h-12 bg-primary hover:bg-primary-hover rounded-full flex items-center justify-center text-white transition-colors"
                  >
                    {isPlaying ? (
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Прямой аудиопоток</p>
                    </div>
