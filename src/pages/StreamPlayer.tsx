...
export default function StreamPlayer() {
  ...
  const connectToStream = async () => {
    ...
    try {
      ...
      // Логируем ВСЕ события публикации от удалённых участников
      ...
      newRoom.on(
        ...
        (track, publication, participant) => {
          console.log("📥 Track subscribed:", {
            ...
            trackSid: publication.trackSid,
            isMuted: publication.isMuted,
            dimensions: (track as any).dimensions, // для видео
          });
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-linear-to-r from-blue-50 to-purple-50 border-b border-gray-200">
                <div className="flex items-center gap-2">
                  <div
                    className={`w-2 h-2 ${isConnected ? "bg-green-500 animate-pulse" : "bg-red-500"} rounded-full`}
                  ></div>
                ...
                {!hasVideo && (
                  <>
                    <div className="relative mb-6">
                      <div
                        className={`absolute inset-0 bg-primary rounded-full animate-ping opacity-20 ${isConnected ? "" : "hidden"}`}
                      ></div>
                      <div
                        className={`absolute inset-2 bg-primary rounded-full animate-pulse opacity-40 ${isConnected ? "" : "hidden"}`}
                      ></div>
                      <button
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              <p className="text-sm text-blue-900">
                <strong>Инфо:</strong> Плеер автоматически переключается в режим
                видео, когда вещатель включает видеостриминг или добавляет
                видеофайлы в плейлист.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
              ...
              <p className="mt-3 text-xs text-gray-500 text-center">
                Нажмите на микрофон для записи голосового сообщения (макс. 60
                секунд)
              </p>
            </div>
